                        ...
                        @foreach ($orders as $key => $order)
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    @endcan
                                    @can('ban_customer')
                                        @if($order->user->banned != 1)
                                            <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm" onclick="confirm_ban('{{route('customers.ban', encrypt($order->user->id))}}');" title="{{ translate('Ban this Customer') }}">
                                                <i class="las la-user-slash"></i>
                                            </a>
                                            @else
                                            <a href="#" class="btn btn-soft-success btn-icon btn-circle btn-sm" onclick="confirm_unban('{{route('customers.ban', encrypt($order->user->id))}}');" title="{{ translate('Unban this Customer') }}">
