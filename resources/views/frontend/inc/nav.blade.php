        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-2 d-none d-lg-block">
                    <ul class="list-inline d-flex justify-content-between justify-content-lg-start mb-0 top_up">
                        <!-- Language switcher -->
                ...
                <div class="col-lg-6 col-12">
                    ...
                    <marquee behavior="" direction="" style="color: #fff;font-size: 16px;align-items: center;display:flex;height: 100%;">Drop shop অনলাইন শপিং এ আপনাকে স্বাগতম । সকাল ৯ টা থেকে রাত ১০ টা পর্যন্ত ফোনে অর্ডার করতে পারবেন, রাত ১০ টার পরে ( অর্ডার করুন ) ক্লিক করে অর্ডার করার জন্য অনুরোধ করছি ।
                   </marquee>
                </div>
                <div class="col-4 text-right d-none d-lg-block pl-0">
                    <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center top_up">
                        @if (get_setting('vendor_system_activation') == 1)
                            <!-- Become a Seller -->
                            <li class="list-inline-item mr-0 pl-0 py-2">
                                <a href="{{ route('shops.create') }}"
                                    class="text-secondary fs-12 pr-2 d-inline-block border-width-2 border-right">{{ translate('Become a Re-seller !') }}</a>
                            </li>
                            <!-- Seller Login -->
                            <li class="list-inline-item mr-0 pl-0 py-2">
                                <a href="{{ route('seller.login') }}"
                                    class="text-secondary fs-12 pl-2 d-inline-block">{{ translate('Login to Re-seller') }}</a>
                            </li>
                        @endif
                        @if (get_setting('helpline_number'))
                            ...
                            <li class="list-inline-item ml-3 mr-0 pr-0">
                                <a href="tel:{{ get_setting('helpline_number') }}"
                                    class=" fs-12 d-inline-block py-2">
                    ...
                    <div class="d-none d-xl-block ml-auto mr-0">
                        @auth
                            <span
                                ...
                                <!-- Name -->
                                <h4 class="h5 fs-14 fw-700 text-dark ml-2 mb-0 user_name">{{ $user->name }}</h4>
                            </span>
                            <!--Login & Registration -->
