        ...
        <div class="col-xl-4 col-md-6 mb-4">
            <div class="p-4 border h-100">
                ...
                @if(Auth::user()->addresses != null)
                    ...
                    @endif
                @endif
                <button class="btn cart-btn text-white btn-block fs-14 fw-500" onclick="add_new_address()" style="border-radius: 25px;">
                    <i class="la la-plus fs-18 fw-700 mr-2"></i>
            ...
            @foreach($wishlists->take(5) as $key => $wishlist)
                @if ($wishlist->product != null)
                    <div class="aiz-card-box col py-3 text-center border-right border-bottom has-transition hov-shadow-out z-1" id="wishlist_{{ $wishlist->id }}">
                        <div class="position-relative h-140px h-md-155px img-fit overflow-hidden mb-3">
                            <!-- Image -->
                        ...
                        <div class="fs-14">
                           ...
                           <!-- add to cart -->
                            <a class="cart-btn mt-3 w-100 h-35px aiz-p-hov-icon text-white fs-13 fw-700 d-flex justify-content-center align-items-center" 
