...
@section('content')
    <style>
        .custom_category {
            box-shadow: 0 0px 27px rgb(40 42 53 / 18%);
        }
        ...
        .Collections {
            ...
            background-image: linear-gradient(160deg, #bd0b0b 0%, #095c67 100%);
            font-size: 40px;
        }
            ...
            <div class="d-flex flex-wrap position-relative">
                ...
                <div class="home-slider">
                    @if (get_setting('home_slider_images') != null)
                        <div class="aiz-carousel dots-inside-bottom" data-autoplay="true" data-items="6" data-xxl-items="4"
                            data-xl-items="4" data-lg-items="4" data-md-items="2" data-sm-items="2" data-xs-items="2"
                            ...
                            @foreach ($sliders as $key => $slider)
                                <div class="carousel-box">
                                    <a href="{{ json_decode(get_setting('home_slider_links'), true)[$key] }}">
                                        <!-- Image -->
                                        <img class="d-block mw-100 img-fit overflow-hidden h-240px h-md-320px h-lg-460px overflow-hidden"
    ...
    <div class="sort-offer">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-6 off-col">
                    <div class="sort-off-img">
                        <a href="">
                            <img src="https://dropshop.com.bd/wp-content/uploads/2024/01/New-Arrival.png" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-lg-4 col-6 off-col">
            ...
            <div class="container">
                <div class="bg-white">
                    ...
                    <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                        <!-- Title -->
                        <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0 category_head">
                            <span class="">DropShop</span>
                            <span class="exclusive">Exclusive</span>
                            <span class="Collections">Collections</span>
                        </h3>
                        <!-- Links -->
                        {{-- <div class="d-flex">
                ...
                <div class="bg-white px-3">
                    ...
                    {{-- <div class="aiz-carousel sm-gutters-17" data-items="8" data-xxl-items="8" data-xl-items="6"
                        ...
                        @foreach ($featured_categories as $key => $category)
                            ...
                            @endphp
                            <div
                                class="carousel-box position-relative text-center p-1">
                                <div class="custom_category has-transition hov-scale-img hov-animate-outline  has-transition hov-scale-img hov-animate-outliner @if ($key == 0) border-left @endif"">
                    ...
                    <div class="row">
                        @foreach ($featured_categories as $key => $category)
                            <div class="col-lg-2 col-4 feature_cat">
                                @php
                                    $category_name = $category->getTranslation('name');
                                @endphp
                                <div
                                    class="custom_category has-transition hov-scale-img hov-animate-outline  has-transition hov-scale-img hov-animate-outliner @if ($key == 0) border-left @endif">
                                    <a href="{{ route('products.category', $category->slug) }}" class="d-flex">
                                        <img src="{{ isset($category->bannerImage->file_name) ? my_asset($category->bannerImage->file_name) : static_asset('assets/img/placeholder.jpg') }}"
                                            class="lazyload h-130px mx-auto has-transition mw-100"
                                            alt="{{ $category->getTranslation('name') }}"
                                            onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';">
                                    </a>
                                    <h6 class="text-truncate-2 category_des">
                                        <a class="text-reset fw-700 fs-14 hov-text-primary"
                                            href="{{ route('products.category', $category->slug) }}"
                                            title="{{ $category_name }}">
                                            {{ $category_name }} <span
                                                style="color:rgb(246 230 3);margin-left:2px;">({{ $category->products->count() }})</span>
                                        </a>
                                    </h6>
                                </div>
                            </div>
