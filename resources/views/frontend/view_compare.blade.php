                                ...
                                @foreach (Session::get('compare') as $key => $item)
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6 py-3">
                                        <div class="border">
                                            ...
                                            <!-- Add to cart -->
                                            <div class="p-4">
                                                <button type="button" class="btn text-center w-100 justify-content-center text-white cart-btn rounded-0 fs-13 fw-700 has-transition opacity-80 hov-opacity-100" onclick="showAddToCartModal({{ $item }})">
